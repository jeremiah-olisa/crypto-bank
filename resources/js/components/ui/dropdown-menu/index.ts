  ...
  ],
  {
    variants: {
      variant: {
        ...
        translucent: " text-gray-400 bg-black/10 text-center focus:outline-none outline-none"
      },

      color: {
        primary: "text-white bg-primary hover:bg-primary-dark ",
        secondary: "text-text-400 bg-secondary hover:bg-secondary-dark ",
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        color: "secondary",
        class:
          "text-text-400 bg-transparent border-text-400 outline-none hover:text-white hover:bg-text-400 dark:hover:bg-gray-100"
      },
      {
        variant: "outline",
        color: "info",
      ...
      // Translucent Buttons
      {
        ...
        color: "primary",
        class:
          "text-primary bg-primary/15 border-transparent hover:text-primary-dark hover:bg-primary/40 dark:text-primary"
      },
      {
        variant: "translucent",
        color: "secondary",
      ...
      },
      {
        ...
        color: "info",
        class:
          "text-info bg-info/15 border-transparent hover:text-info-dark hover:bg-info/40 dark:hover:text-info"
      },
      {
        variant: "translucent",
        color: "success",
        class:
          "text-success bg-success/15 border-transparent hover:text-success-dark hover:bg-success/40 dark:hover:text-success"
      },
      {
        variant: "translucent",
        color: "warning",
        class:
          "text-warning bg-warning/15 border-transparent hover:text-warning-dark hover:bg-warning/40 dark:hover:text-warning"
      },
      {
        variant: "translucent",
        color: "error",
        class:
          "text-error bg-error/15 border-transparent hover:text-error-dark hover:bg-error/40 dark:hover:text-error"
      }
    ],
  ...
  ["text-xs px-3 py-2 leading-normal transition-all duration-300 ease-in-out block"],
  {
    variants: {
      variant: {
        ...
        translucent: " text-gray-400  bg-black/10  focus:outline-none outline-none"
      },
    ...
    compoundVariants: [
      // Primary Button
      {
        ...
        color: "primary",
        class:
          "text-muted-300 hover:text-primary bg-transparent border-primary outline-none hover:bg-gray-100 dark:hover:bg-dark-bgHover dark:border-primary dark:text-white dark:hover:text-primary"
      },
      {
        variant: "outline",
        color: "secondary",
        class:
          "text-text-400 bg-transparent border-text-400 outline-none hover:text-white hover:!bg-dark dark:hover:bg-gray-100 dark:hover:bg-dark-bgHover "
      },
      {
        variant: "outline",
        color: "info",
